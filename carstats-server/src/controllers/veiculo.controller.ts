...
export class VeiculoController {
    ...
    async buscarPorId(@Param('id') id: number, @Req() req: Request): Promise<VeiculoResponseDto> {
        const idUsuario = req.usuario.id;
    ...
    async criarManutencao(
        ...
        return await this.manutencaoService.criar(veiculoId, createManutencaoDto, idUsuario);
    }
